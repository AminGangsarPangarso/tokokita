...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2023 at 02:05 AM
...
(1, 'fajri', '437eb04136c59d226f14527f52726341', 'Ika Nur Fajri', 'Pakahan Jogonalan Klaten', NULL, 'fajri@amikom.ac.id', 668, 'Y');
...
CREATE TABLE `tbl_ongkir` (
  `idOngkir` int(3) NOT NULL,
  `tujuan` varchar(50) DEFAULT NULL,
  `kurir` varchar(25) DEFAULT NULL,
  `ongkos` int(6) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(3, 1, 'Tokoku', 'pngtree-online.jpg', 'Des', 'Y');
...
--
ALTER TABLE `tbl_kategori`
  MODIFY `idkat` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tbl_ongkir`
  MODIFY `idOngkir` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_toko`
  MODIFY `idToko` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
